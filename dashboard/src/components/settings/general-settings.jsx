    ...
    >
      ...
      <div className="mt-8 pt-6 border-t border-red-500/20 space-y-3">
        ...
        <p className="text-[11px] text-gray-400 leading-relaxed">
          تتيح لك هذه الميزة حذف وتصفير جميع الحركات المالية والعمليات التنفيذية بالكامل (المشتريات، المبيعات، المصروفات، طلبات الإنتاج، والرواتب واليوميات)، وتصفير كافة الديون. مع **الحفاظ الكامل** على الموردين، العملاء، الموظفين، بيانات التسجيل، المستخدمين، المواد الخام، الأثاث والمنتجات الجاهزة، الفئات والمخازن.
        </p>
        <button
          type="button"
