...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $whRaw = Warehouse::create([
            'name' => 'المواد الخام',
            'code' => 'WSH-M',
            'description' => 'المخزن الرئيسي لتخزين المواد الخام الواردة من الموردين',
            'address' => 'المنطقة الصناعية، الرياض - البوابة الشرقية',
            'notes' => 'قريب من خط الإنتاج الأول'
        ]);

        $whProd = Warehouse::create([
            'name' => 'المنتجات',
            'code' => 'WSH-P',
            'description' => 'مخزن مخصص لتخزين المنتجات الجاهزة (غير المخصصة لطلبات عملاء مباشرة)',
            'address' => 'المنطقة الصناعية، الرياض',
            'notes' => 'تخزين المنتجات الجاهزة'
        ]);

        $whFin = Warehouse::create([
            'name' => 'طلبيات',
            'code' => 'WH-FIN',
            'description' => 'مخزن مخصص لحفظ المنتجات الجاهزة للتسليم النهائي للعملاء',
