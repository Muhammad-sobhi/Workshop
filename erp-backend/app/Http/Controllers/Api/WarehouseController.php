...
class WarehouseController extends Controller
{
    public function index(): JsonResponse
    {
        ...
        $stockCase = "SUM(CASE WHEN movement_type IN ('Initial_Balance','Purchase_Receipt','Production_Receipt','Transfer_In','Waste_Receipt') OR (movement_type='Stock_Adjustment' AND quantity>0) THEN quantity WHEN movement_type IN ('Production_Consumption','Sales_Issue','Supplier_Return','Damaged','Transfer_Out','Production_Waste') OR (movement_type='Stock_Adjustment' AND quantity<0) THEN -quantity ELSE 0 END)";
